# Dockerizing OzDaigou: Dockerfile for building OzDaigou images
# Based on openjdk:8, installs MongoDB following the instructions from:
# https://hub.docker.com/r/_/mongo/
FROM openjdk:8

MAINTAINER Audrey <audreybest@gmail.com>
